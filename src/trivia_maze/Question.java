...
public class Question {
	...
	public Question(String thePrompt, String theCorrectAnswer, String[] theWrongAnswers, boolean theAnswered) {
		myPrompt = thePrompt;
	...
	/**
	 * Check if the answer from user is correct. 3 different cases, True/False case, Multplie choice, short answer.
